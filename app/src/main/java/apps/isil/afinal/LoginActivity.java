        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    ...
                    loginEmail.setError("El email no puede estar vacio.");
                }
                else {
                    loginEmail.setError("Ingrese un email correcto.");
                }
            }
        });
                ...
                dialogView.findViewById(R.id.btnReset).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (TextUtils.isEmpty(userEmail) && !Patterns.EMAIL_ADDRESS.matcher(userEmail).matches()){
                            Toast.makeText(LoginActivity.this, "Ingrese su email registrado.", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        auth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(LoginActivity.this, "Revisar su bandeja de entrada.", Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
                                }
                                else {
